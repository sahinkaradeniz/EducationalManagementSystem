...
class TaskAdapterStudent(var taskList:ArrayList<Task>): RecyclerView.Adapter<TaskAdapterStudent.ViewHolder>() {
    class ViewHolder(val taskRowBinding: RowTaskStudentBinding): RecyclerView.ViewHolder(taskRowBinding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val rcvBinding=RowTaskStudentBinding.inflate(LayoutInflater.from(parent.context),parent,false)
